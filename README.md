...
<table width="100%">
  <tr>
    ...
    <td align="center" width="33%">
      <a href="https://www.youtube.com/watch?v=5vG3SXhxaqc">
        <img src="https://img.youtube.com/vi/5vG3SXhxaqc/mqdefault.jpg" width="100%" alt="TikTok AI Beauty UGC Video Demo"/><br>
        <strong>Demo 2 (뷰티 UGC 영상 생성)</strong>
      </a>
    </td>
    <td align="center" width="33%">
      <a href="https://www.youtube.com/watch?v=Ck9YlKDKHHs">
        <img src="https://img.youtube.com/vi/Ck9YlKDKHHs/mqdefault.jpg" width="100%" alt="TikTok AI Fashion UGC Video Demo"/><br>
...
- [/] Seedance 기반 AI UGC 광고 영상 생성 기능 개발 완료 (서비스 반영 예정): 완성된 After 이미지와 브랜드 자산을 기반으로, 숏폼 및 마케팅에 즉시 활용 가능한 UGC(사용자 생성 콘텐츠) 스타일의 AI 광고 영상을 자율 생성하는 핵심 파이프라인 기능 개발 완료 ([뷰티 데모](https://www.youtube.com/watch?v=5vG3SXhxaqc) / [패션 데모](https://www.youtube.com/watch?v=Ck9YlKDKHHs))
