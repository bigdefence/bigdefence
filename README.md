...
**2026.06 - 현재** | [Demo 1 (이미지 생성)](https://www.youtube.com/watch?v=Q02SbqLwhbg) | [Demo 2 (UGC 영상 생성)](https://www.youtube.com/watch?v=vXXip9E2Mzc)
...
<div align="center">
  ...
  <a href="https://www.youtube.com/watch?v=vXXip9E2Mzc"><img src="https://img.youtube.com/vi/vXXip9E2Mzc/maxresdefault.jpg" width="49%" alt="TikTok AI Beauty UGC Video Demo"/></a>
</div>
...
- [/] Seedance 기반 AI UGC 광고 영상 생성 기능 개발 완료 (서비스 반영 예정): 완성된 After 이미지와 브랜드 자산을 기반으로, 숏폼 및 마케팅에 즉시 활용 가능한 UGC(사용자 생성 콘텐츠) 스타일의 AI 광고 영상을 자율 생성하는 핵심 파이프라인 기능 개발 완료 ([데모 영상](https://www.youtube.com/watch?v=vXXip9E2Mzc))
