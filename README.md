...
> **Magic Canvas** — 700+ 템플릿과 인물·제품 레퍼런스를 바탕으로 GPT Image 2로 이미지를 생성하고, **디테일 편집** 캔버스에서 **직관적인 드로잉**으로 정교하게 다듬는 에이전틱 이미지 생성 서비스입니다. Supabase 인증·스토리지, Lemon Squeezy 크레딧 결제, Vercel·Cloud Run 운영 환경을 통합했습니다.
...
- ✅ **700+ 템플릿 & 자동 스타일 확장**: 다채로운 기본 템플릿과 새로운 스타일 데이터를 에이전트가 분석·적용합니다. 템플릿 데이터가 늘어나도 운영 복잡도를 낮게 유지하는 관리 구조를 설계했습니다.
