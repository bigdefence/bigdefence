...
### 🪄 Magic Template — Agentic 템플릿 기반 이미지 생성 서비스(Seedance 기반 AI UGC 광고 영상 제작 서비스 확장 예정)

**2026.06 - 현재** | [Demo](https://www.youtube.com/watch?v=Q02SbqLwhbg)

[![Magic Template Demo](https://img.youtube.com/vi/Q02SbqLwhbg/maxresdefault.jpg)](https://www.youtube.com/watch?v=Q02SbqLwhbg)
...
- 🔲 Seedance 기반 AI UGC 광고 영상 생성 기능 추가 예정: 완성된 After 이미지와 브랜드 자산을 기반으로, 숏폼 및 마케팅에 즉시 활용 가능한 UGC(사용자 생성 콘텐츠) 스타일의 AI 광고 영상을 자율 생성하는 파이프라인 확장 준비 중
